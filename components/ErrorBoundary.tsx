...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  async logErrorToBackend(error: Error, errorInfo: React.ErrorInfo, errorId: string): Promise<void> {
    try {
      const isAuth = await apiClient.auth.isAuthenticated().catch(() => false);
